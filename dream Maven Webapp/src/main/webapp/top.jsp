            ...
            <td width="248" background="images/main_06.gif"><table width="225" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="17"><div align="right">
                	<a href="${ctx}/user/toUpdatePassword.action?item.id=${loginUser.id}" target="rightFrame">
                		<img src="images/pass.gif" width="69" height="17" /></a></div></td>
                <td><div align="right">
                	<a href="${ctx}/user/toViewUser.action">
                		<img src="images/user.gif" width="69" height="17" />
                		</a></div>
                </td>
                <td><div align="right">
                	<a href="${ctx}/backToLogin.action" target="_top">
                		<img src="images/quit.gif" width="69" height="17" /></a></div></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
      ...
      <tr>
        ...
        <td width="248" background="images/main_11.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="75%"><div align="center"><span class="STYLE7" id="nowtime">${loginUser.loginTime}</span></div></td>
            <td width="9%">&nbsp;</td>
          </tr>
        </table></td>
      </tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="20" valign="bottom">
            	<span class="STYLE1">当前登录用户：${loginUser.name} &nbsp;用户角色：
            		<c:if test="${loginUser.role.id==1}">管理员</c:if>
            		<c:if test="${loginUser.role.id==2}">经理</c:if>
            		<c:if test="${loginUser.role.id==3}">员工</c:if>
            		<c:if test="${loginUser.role.id==4}">访客</c:if>
            	</span>
            </td>
            <td valign="bottom" class="STYLE1">
            	<div align="right"><img src="images/sj.gif" width="6" height="7" />${loginUser.loginip}&nbsp;&nbsp;
            	 <img src="images/sj.gif" width="6" height="7" />
            	  &nbsp;提供商：${loginUser.name} &nbsp; &nbsp; 
            	  <img src="images/sj.gif" width="6" height="7" /> &nbsp;单位：${loginUser.name}</div></td>
          </tr>
        </table></td>
