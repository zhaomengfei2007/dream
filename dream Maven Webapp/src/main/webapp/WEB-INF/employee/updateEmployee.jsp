...
${index_css}
${validate_css}
	<s:form action="doUpdateEmployee" namespace="/employee" id="edit_form">
		<s:hidden name="employee.id" id="id"></s:hidden>
		<table class="data_table" border="1">
			...
			<tr>
				<td>毕业时间</td>
				<td><s:textfield name="employee.graduate" cssClass="Wdate" onClick="WdatePicker()" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd'})"/></td>
			</tr>
			<tr>
				<td>专业</td>
			...
			<tr>
				<td>籍贯</td>
				<td><s:select name="employee.city.id" list="cityList" listKey="id" listValue="name"></s:select></td>
			</tr>
			<tr>
				<td>入职时间</td>
...
$(function(){
	...
	$("#btnsave").click(function(){
		...
		if($("#edit_form").valid()){
				...
				var url = "${ctx}/employee/doUpdateEmployee.action";
